...
export class Contract__currentStrategyResultValue0Struct extends EthereumTuple {
  get endBlockNumber(): BigInt {
...
export class Contract__getUnstakeResultResultStruct extends EthereumTuple {
  get amount(): BigInt {
    return this[0].toBigInt();
  }
...
export class Contract__nextStrategyResultValue0Struct extends EthereumTuple {
  get endBlockNumber(): BigInt {
    return this[0].toBigInt();
  }
...
export class Contract extends SmartContract {
  ...
  try_DEFAULT_PRICE(): CallResult<Contract__DEFAULT_PRICEResult> {
  ...
  try_calculateUnstake(
    account: Address,
    amount: BigInt
  ): CallResult<Contract__calculateUnstakeResult> {
  ...
  try_claim(amount: BigInt): CallResult<Contract__claimResult> {
  ...
  try_getUnlockedRewards(): CallResult<Contract__getUnlockedRewardsResult> {
  ...
  try_getUnstake(
    account: Address
  ): CallResult<Contract__getUnstakeResultResultStruct> {
  ...
  try_nextStrategy(): CallResult<Contract__nextStrategyResultValue0Struct> {
  ...
  try_price(): CallResult<Contract__priceResult> {
  ...
  try_priceStored(): CallResult<Contract__priceStoredResult> {
  ...
  try_unstake(amount: BigInt): CallResult<Contract__unstakeResult> {
